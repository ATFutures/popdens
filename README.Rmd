...
Current analyses use `worldpop` only. Potential extension to incorporate NASA
data to allow for future projections.

# usage

This package currently contains only one function which maps the population
density layers in [`who-data`](https://github.com/ATFutures/who-data) onto the
nearest OSM nodes, and dumps the resultant data in that repo (as
